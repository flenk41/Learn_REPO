...
> 🏛️ В C **нет классов** — это процедурный язык. Но идею инкапсуляции он даёт через
> модульность и opaque-типы (модуль 16, раздел «Проекты и API»). Полноценное ООП — в
> [➕ C++](../Cpp/README.md) и в язык-агностичном треке [🏛️ ООП](../OOP/README.md).
